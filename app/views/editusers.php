...
<div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    <h1 class="font-bold text-center text-2xl mb-5">Edit User</h1>  
    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      <div class="px-5 py-7">
        <!-- php -->
        <?php foreach($edit_data_array as $data) :?>
            <label class="font-semibold text-sm text-gray-600 pb-1 block">Name</label>
            <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" name="name" value="<?php $data['name']?>" />
            ...
            <label class="font-semibold text-sm text-gray-600 pb-1 block">Address</label>
            <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" name="address"/>
            <label class="font-semibold text-sm text-gray-600 pb-1 block">Phone</label>
            <input type="number" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" name="phone" />
            <button type="submit" class="transition duration-200 bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
                <span class="inline-block mr-2">Add User</span>
